...
class DB_object
{
    ...
    public $upload_errors_array = array(
        UPLOAD_ERR_OK => "There is not error",
        UPLOAD_ERR_INI_SIZE => "The upload file exceeds the upload max filesize from php.ini",
        UPLOAD_ERR_FORM_SIZE => "The upload file size exceeds MAX FILE SIZE on php.oni for html form",
